            ...
            <div class="detailevent-content" style="margin-bottom:50px;">  
                ...
                <div class="box-event">  
                    ...
                    <div class="group-btn" style="display:block;">
                        ...
                        @else
                            <a style="color:grey; border-color:grey; cursor: not-allowed;display:block;" title="Proposal event not uploaded yet" class="booth-button" target="_blank">
                                <i class="fa-solid fa-file-pdf"></i>Proposal Event
                            </a>
                        @endif
                    </div>
